            ...
            <div class="absolute bottom-0 left-0 right-0 pb-12 z-10">
                <div class="container mx-auto px-6">
                    <div class="flex items-center gap-3 mb-4">
                        <div class="inline-block px-4 py-2 bg-blue-600 text-white rounded-full font-semibold">
                            {{ $destinasi->wilayah->nama }}
                        </div>
                        @if($destinasi->tipe === 'wisata')
                            <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold bg-blue-500/95 text-white backdrop-blur-sm">
                                <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                Wisata
                            </span>
                        @elseif($destinasi->tipe === 'kuliner')
                            <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold bg-orange-500/95 text-white backdrop-blur-sm">
