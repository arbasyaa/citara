        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
                    <h2 class="text-2xl font-bold text-gray-800 mb-4">{{ __('site.about_destination') }}</h2>
                ...
                @if($destinasi->foto->isNotEmpty())
                    <div class="bg-white rounded-lg shadow-lg p-6">
                        <h2 class="text-2xl font-bold text-gray-800 mb-4">{{ __('site.photo_gallery') }}</h2>
            ...
            <div class="space-y-6">
                <!-- Location Info -->
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-4">{{ __('site.location') }}</h3>
                ...
                @if($destinasi->wilayah->destinasi->where('id', '!=', $destinasi->id)->isNotEmpty())
                    <div class="bg-white rounded-lg shadow-lg p-6">
                        <h3 class="text-xl font-bold text-gray-800 mb-4">{{ __('site.other_destinations_in') }} {{ $destinasi->wilayah->nama }}</h3>
                        <div class="space-y-4">
