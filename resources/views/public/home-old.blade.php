...
@section('content')
    ...
    <section class="py-24 bg-white">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16 slide-up">
                <h2 class="text-4xl font-bold text-gray-900 mb-4">{{ __('site.featured_popular') }}</h2>
                <p class="text-xl text-gray-600">{{ __('site.featured_popular_subtitle') }}</p>
            </div>
    ...
    <section class="py-24 bg-gray-50 relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 relative">
            <div class="text-center mb-16 slide-up">
                <h2 class="text-4xl font-bold text-gray-900 mb-4">{{ __('site.tourism_areas') }}</h2>
                <p class="text-xl text-gray-600">{{ __('site.tourism_areas_subtitle') }}</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <a href="{{ route('wilayah.show', $area->slug) }}" class="group">
                        <div class="bg-white rounded-xl p-8 shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-xl">
                            ...
                            <div class="flex items-center text-blue-600">
                                <span class="font-medium">{{ $area->destinasi_count }} {{ __('site.destinations') }}</span>
    ...
    <section class="py-24 bg-gray-50">
        <div class="container mx-auto px-6">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold text-gray-900 mb-4">{{ __('site.event_calendar') }}</h2>
                <p class="text-xl text-gray-600">{{ __('site.event_calendar_subtitle') }}</p>
            </div>
