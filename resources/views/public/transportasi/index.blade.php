                    ...
                    <article class="dest-card bg-white rounded-2xl shadow-lg overflow-hidden group">
                        <div class="relative h-64 overflow-hidden">
                            @if(!empty($t->thumbnail))
                                <img src="{{ Storage::url($t->thumbnail) }}" alt="{{ $t->nama }}" class="dest-image w-full h-full object-cover">
                            @else
                        ...
                        <div class="p-6">
                            ...
                            @endif
                            <a href="{{ route('transportasi.show', $t) }}" class="btn-view inline-flex items-center gap-2 px-6 py-3 text-white rounded-xl font-semibold shadow-lg">
                                {{ __('site.read_more') }}
