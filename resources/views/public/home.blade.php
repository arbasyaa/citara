    ...
    <section class="parallax-section relative cta-section" {!! $ctaBackgroundUrl ? 'style="background-image: url(' . e($ctaBackgroundUrl) . ');"' : '' !!}>
        ...
        <div class="container mx-auto px-6 relative z-10 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-6 justify-center">
                ...
                <a href="https://drive.google.com/uc?export=download&id=1OIaIZ0te3aY5XnXMlyUD_6_NuuqysYze" class="inline-flex items-center justify-center gap-2 px-10 py-5 rounded-xl bg-white text-blue-600 font-bold text-lg shadow-2xl hover:bg-gray-100 transition-all" download>
