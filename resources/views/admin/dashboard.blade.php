...
@section('content')
    ...
    <a href="{{ route('panel.destinasi.index') }}" class="group rounded-xl overflow-hidden shadow bg-gradient-to-br from-pink-500 to-rose-600 text-white">
            <div class="p-5 flex items-center justify-between">
                <div>
                    <div class="text-sm opacity-80">Destinasi</div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-100">
            <div class="p-5 border-b">
                <h3 class="font-semibold text-gray-800">Analisis Situs</h3>
                <p class="text-sm text-gray-500">Ikhtisar bulan terakhir</p>
            </div>
            <div class="p-6">
        ...
        <div class="space-y-6">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                <h4 class="font-semibold mb-4">Statistik Cepat</h4>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                ...
                <div class="flex flex-wrap gap-3">
                    <a href="{{ route('panel.events.create') }}" class="px-4 py-2 rounded-md bg-emerald-600 text-white hover:bg-emerald-700">Kegiatan Baru</a>
                    <a href="{{ route('panel.destinasi.index') }}" class="px-4 py-2 rounded-md bg-pink-600 text-white hover:bg-pink-700">Kelola Destinasi</a>
                </div>
            </div>
        </div>
    </div>
